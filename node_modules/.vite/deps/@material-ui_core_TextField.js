import {
  ...
  withStyles_default,
  zIndex_default
} from "./chunk-7ABHOSFG.js";
import {
  clsx_m_default
} from "./chunk-KW6C7XJQ.js";
import {
  Transition_default
} from "./chunk-ZGWCIPYA.js";
import {
  _defineProperty,
  _typeof
...
var FormControl = React13.forwardRef(function FormControl2(props, ref) {
  ...
  var _React$useState2 = React13.useState(function() {
  ...
  var _React$useState3 = React13.useState(false), _focused = _React$useState3[0], setFocused = _React$useState3[1];
  ...
  var registerEffect;
  if (true) {
    var registeredInput = React13.useRef(false);
  ...
  var onFilled = React13.useCallback(function() {
    setFilled(true);
  }, []);
  var onEmpty = React13.useCallback(function() {
    setFilled(false);
  }, []);
  var childContext = {
    adornedStart,
  ...
  return React13.createElement(FormControlContext_default.Provider, {
    value: childContext
  }, React13.createElement(Component4, _extends({
...
var FormHelperText = React14.forwardRef(function FormHelperText2(props, ref) {
  ...
  return React14.createElement(Component4, _extends({
...
var Portal = React15.forwardRef(function Portal2(props, ref) {
  ...
  var _React$useState = React15.useState(null), mountNode = _React$useState[0], setMountNode = _React$useState[1];
  var handleRef = useForkRef(React15.isValidElement(children) ? children.ref : null, ref);
...
function Unstable_TrapFocus(props) {
  ...
  var ignoreNextEnforceFocus = React16.useRef();
  var sentinelStart = React16.useRef(null);
  var sentinelEnd = React16.useRef(null);
  var nodeToRestore = React16.useRef();
  var rootRef = React16.useRef(null);
  var handleOwnRef = React16.useCallback(function(instance) {
    rootRef.current = ReactDOM2.findDOMNode(instance);
  }, []);
  var handleRef = useForkRef(children.ref, handleOwnRef);
  var prevOpenRef = React16.useRef();
...
var SimpleBackdrop = React17.forwardRef(function SimpleBackdrop2(props, ref) {
  ...
  return open ? React17.createElement("div", _extends({
    "aria-hidden": true,
    ref
  }, other, {
...
var Modal = React18.forwardRef(function Modal2(inProps, ref) {
  var theme = useTheme();
  ...
  var _React$useState = React18.useState(true), exited = _React$useState[0], setExited = _React$useState[1];
  var modal = React18.useRef({});
  var mountNodeRef = React18.useRef(null);
  var modalRef = React18.useRef(null);
  ...
  var isTopModal = React18.useCallback(function() {
  ...
  var handleClose = React18.useCallback(function() {
  ...
  return React18.createElement(Portal_default, {
    ref: handlePortalRef,
    container,
    disablePortal
  ...
  }), hideBackdrop ? null : React18.createElement(BackdropComponent, _extends({
    open,
    onClick: handleBackdropClick
  }, BackdropProps)), React18.createElement(Unstable_TrapFocus_default, {
    disableEnforceFocus,
    disableAutoFocus,
    disableRestoreFocus,
    getDoc,
    ...
    open
  }, React18.cloneElement(children, childProps))));
});
true ? Modal.propTypes = {
   ...
   * so it's simply `document.body` most of the time.
   */
  container: import_prop_types14.default.oneOfType([HTMLElementType, import_prop_types14.default.instanceOf(React18.Component), import_prop_types14.default.func]),
  /**
...
var Grow = React19.forwardRef(function Grow2(props, ref) {
  ...
  var autoTimeout = React19.useRef();
  var theme = useTheme2();
...
var Popover = React21.forwardRef(function Popover2(props, ref) {
  ...
  var paperRef = React21.useRef();
  var getAnchorOffset = React21.useCallback(function(contentAnchorOffset) {
  ...
  var getContentAnchorOffset = React21.useCallback(function(element) {
  ...
  var getTransformOrigin = React21.useCallback(function(elemRect) {
  ...
  var getPositioningStyle = React21.useCallback(function(element) {
  ...
  var setPositioningStyles = React21.useCallback(function() {
  ...
  var handlePaperRef = React21.useCallback(function(instance) {
  ...
  React21.useImperativeHandle(action, function() {
    return open ? {
  ...
  return React21.createElement(Modal_default, _extends({
    container,
    open,
    ref,
    BackdropProps: {
    ...
    className: clsx_m_default(classes.root, className)
  }, other), React21.createElement(TransitionComponent, _extends({
    appear: true,
    in: open,
    onEnter,
    onEntered,
  ...
  }), React21.createElement(Paper_default, _extends({
    elevation,
    ref: handlePaperRef
  }, PaperProps, {
...
true ? Popover.propTypes = {
   ...
   * so it's simply `document.body` most of the time.
   */
  container: import_prop_types17.default.oneOfType([HTMLElementType, import_prop_types17.default.instanceOf(React21.Component), import_prop_types17.default.func]),
  /**
...
var List = React23.forwardRef(function List2(props, ref) {
  ...
  return React23.createElement(ListContext_default.Provider, {
    value: context
  }, React23.createElement(Component4, _extends({
...
var useEnhancedEffect4 = typeof window === "undefined" ? React24.useEffect : React24.useLayoutEffect;
var MenuList = React24.forwardRef(function MenuList2(props, ref) {
  ...
  var listRef = React24.useRef(null);
  var textCriteriaRef = React24.useRef({
    keys: [],
    repeating: true,
  ...
  React24.useImperativeHandle(actions, function() {
    return {
  ...
  var handleOwnRef = React24.useCallback(function(instance) {
    listRef.current = ReactDOM5.findDOMNode(instance);
  }, []);
  var handleRef = useForkRef(handleOwnRef, ref);
  var activeItemIndex = -1;
  React24.Children.forEach(children, function(child, index) {
  ...
  return React24.createElement(List_default, _extends({
    role: "menu",
    ref: handleRef,
    className,
    onKeyDown: handleKeyDown,
...
var Menu = React25.forwardRef(function Menu2(props, ref) {
  ...
  var menuListActionsRef = React25.useRef(null);
  var contentAnchorRef = React25.useRef(null);
  ...
  var items = React25.Children.map(children, function(child, index) {
    if (index === activeItemIndex) {
  ...
  return React25.createElement(Popover_default, _extends({
    getContentAnchorEl,
    ...
    ref,
    transitionDuration
  }, other), React25.createElement(MenuList_default, _extends({
...
var SelectInput = React27.forwardRef(function SelectInput2(props, ref) {
  ...
  var inputRef = React27.useRef(null);
  var _React$useState = React27.useState(null), displayNode = _React$useState[0], setDisplayNode = _React$useState[1];
  var _React$useRef = React27.useRef(openProp != null), isOpenControlled = _React$useRef.current;
  var _React$useState2 = React27.useState(), menuMinWidthState = _React$useState2[0], setMenuMinWidthState = _React$useState2[1];
  var _React$useState3 = React27.useState(false), openState = _React$useState3[0], setOpenState = _React$useState3[1];
  var handleRef = useForkRef(ref, inputRefProp);
  React27.useImperativeHandle(handleRef, function() {
    return {
  ...
  var childrenArray = React27.Children.toArray(children);
  var handleChange = function handleChange2(event) {
  ...
  return React27.createElement(React27.Fragment, null, React27.createElement("div", _extends({
  ...
  ) : display), React27.createElement("input", _extends({
    ...
    autoFocus
  }, other)), React27.createElement(IconComponent, {
  ...
  }), React27.createElement(Menu_default, _extends({
    id: "menu-".concat(name || ""),
...
var SvgIcon = React28.forwardRef(function SvgIcon2(props, ref) {
  ...
  return React28.createElement(Component4, _extends({
    ...
    ref
  }, other), children, titleAccess ? React28.createElement("title", null, titleAccess) : null);
});
true ? SvgIcon.propTypes = {
   ...
   */
  color: import_prop_types22.default.oneOf(["action", "disabled", "error", "inherit", "primary", "secondary"]),
  /**
   * The component used for the root node.
   * Either a string to use a HTML element or a component.
   */
   ...
   */
  fontSize: chainPropTypes(import_prop_types22.default.oneOf(["default", "inherit", "large", "medium", "small"]), function(props) {
...
var SvgIcon_default = withStyles_default(styles28, {
  name: "MuiSvgIcon"
})(SvgIcon);
...
function createSvgIcon(path, displayName) {
  ...
  return import_react2.default.memo(import_react2.default.forwardRef(Component4));
}

// node_modules/@material-ui/core/esm/internal/svg-icons/ArrowDropDown.js
var ArrowDropDown_default = createSvgIcon(React30.createElement("path", {
  d: "M7 10l5 5 5-5z"
}), "ArrowDropDown");
...
var NativeSelectInput = React31.forwardRef(function NativeSelectInput2(props, ref) {
  ...
  return React31.createElement(React31.Fragment, null, React31.createElement("select", _extends({
    className: clsx_m_default(
      classes.root,
      // TODO v5: merge root and select
      classes.select,
    ...
    disabled,
    ref: inputRef || ref
  }, other)), props.multiple ? null : React31.createElement(IconComponent, {
...
var defaultInput = React32.createElement(Input_default, null);
var NativeSelect = React32.forwardRef(function NativeSelect2(props, ref) {
  ...
  return React32.cloneElement(input, _extends({
...
var NativeSelect_default = withStyles_default(styles30, {
  name: "MuiNativeSelect"
})(NativeSelect);

// node_modules/@material-ui/core/esm/Select/Select.js
var styles32 = styles30;
var _ref = React33.createElement(Input_default, null);
var _ref2 = React33.createElement(FilledInput_default, null);
var Select = React33.forwardRef(function Select2(props, ref) {
  ...
  var InputComponent = input || {
    standard: _ref,
    outlined: React33.createElement(OutlinedInput_default, {
      label,
      labelWidth
    }),
    filled: _ref2
  }[variant];
  return React33.cloneElement(InputComponent, _extends({
...
true ? Select.propTypes = {
   ...
   * See [OutlinedInput#label](/api/outlined-input/#props)
   */
  labelWidth: import_prop_types25.default.number,
  /**
   * Props applied to the [`Menu`](/api/menu/) element.
   */
...
var Select_default = withStyles_default(styles32, {
  name: "MuiSelect"
})(Select);
...
var TextField = React34.forwardRef(function TextField2(props, ref) {
  ...
  if (variant === "outlined") {
    ...
    if (label) {
      ...
      InputMore.label = React34.createElement(React34.Fragment, null, label, displayRequired && " *");
    }
  }
  if (select) {
  ...
  var InputElement = React34.createElement(InputComponent, _extends({
  ...
  return React34.createElement(FormControl_default, _extends({
    className: clsx_m_default(classes.root, className),
    disabled,
    error,
    fullWidth,
    ...
    color,
    variant
  }, other), label && React34.createElement(InputLabel_default, _extends({
    htmlFor: id,
    id: inputLabelId
  }, InputLabelProps), label), select ? React34.createElement(Select_default, _extends({
    "aria-describedby": helperTextId,
    id,
    labelId: inputLabelId,
    value,
    input: InputElement
  }, SelectProps), children) : InputElement, helperText && React34.createElement(FormHelperText_default, _extends({
    id: helperTextId
...
var TextField_default = withStyles_default(styles33, {
  name: "MuiTextField"
})(TextField);
export {
