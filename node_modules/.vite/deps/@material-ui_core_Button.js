import {
  ...
  useForkRef,
  withStyles_default
} from "./chunk-R67X6D5J.js";
import {
  clsx_m_default
} from "./chunk-KW6C7XJQ.js";
import {
  TransitionGroup_default
} from "./chunk-LVZM2ARN.js";
import {
  require_react_dom
...
function Ripple(props) {
  ...
  var _React$useState = React2.useState(false), leaving = _React$useState[0], setLeaving = _React$useState[1];
...
var TouchRipple = React3.forwardRef(function TouchRipple2(props, ref) {
  ...
  var _React$useState = React3.useState([]), ripples = _React$useState[0], setRipples = _React$useState[1];
  var nextKey = React3.useRef(0);
  var rippleCallback = React3.useRef(null);
  ...
  var ignoringMouseDown = React3.useRef(false);
  var startTimer = React3.useRef(null);
  var startTimerCommit = React3.useRef(null);
  var container = React3.useRef(null);
  React3.useEffect(function() {
    return function() {
      clearTimeout(startTimer.current);
    };
  }, []);
  var startCommit = React3.useCallback(function(params) {
    ...
    setRipples(function(oldRipples) {
      return [].concat(_toConsumableArray(oldRipples), [React3.createElement(Ripple_default, {
        key: nextKey.current,
        classes,
        timeout: DURATION,
        pulsate: pulsate2,
  ...
  var start = React3.useCallback(function() {
  ...
  var pulsate = React3.useCallback(function() {
    start({}, {
      pulsate: true
    });
  }, [start]);
  var stop = React3.useCallback(function(event, cb) {
    clearTimeout(startTimer.current);
  ...
  return React3.createElement("span", _extends({
    ...
    ref: container
  }, other), React3.createElement(TransitionGroup_default, {
    component: null,
    exit: true
  }, ripples));
});
...
var ButtonBase = React4.forwardRef(function ButtonBase2(props, ref) {
  ...
  var buttonRef = React4.useRef(null);
  function getButtonNode() {
    return ReactDOM2.findDOMNode(buttonRef.current);
  }
  var rippleRef = React4.useRef(null);
  var _React$useState = React4.useState(false), focusVisible = _React$useState[0], setFocusVisible = _React$useState[1];
  ...
  React4.useImperativeHandle(action, function() {
    return {
  ...
  var keydownRef = React4.useRef(false);
  ...
  var _React$useState2 = React4.useState(false), mountedState = _React$useState2[0], setMountedState = _React$useState2[1];
  React4.useEffect(function() {
  ...
  return React4.createElement(ComponentProp, _extends({
    ...
    React4.createElement(TouchRipple_default, _extends({
      ref: rippleRef,
      center: centerRipple
    }, TouchRippleProps))
  ) : null);
...
var Button = React5.forwardRef(function Button2(props, ref) {
  ...
  var startIcon = startIconProp && React5.createElement("span", {
    className: clsx_m_default(classes.startIcon, classes["iconSize".concat(capitalize(size))])
  }, startIconProp);
  var endIcon = endIconProp && React5.createElement("span", {
  ...
  return React5.createElement(ButtonBase_default, _extends({
    ...
    ref,
    type
  }, other), React5.createElement("span", {
...
true ? Button.propTypes = {
   ...
   */
  size: import_prop_types4.default.oneOf(["large", "medium", "small"]),
  /**
   ...
   * The variant to use.
   */
  variant: import_prop_types4.default.oneOf(["contained", "outlined", "text"])
} : void 0;
